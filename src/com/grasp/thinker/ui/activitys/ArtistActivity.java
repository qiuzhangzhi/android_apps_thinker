...
import com.grasp.thinker.loaders.ArtistSongLoader;
 ...
 */
public class ArtistActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<List<Song>>,AdapterView.OnItemClickListener{

    public final static int SONG_LOADER = 4;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mActionbarTitle = bundle.getString(ThinkerConstant.ARTIST_NAME);
    ...
    public Loader<List<Song>> onCreateLoader(int i, Bundle bundle) {
        return new ArtistSongLoader(this,bundle.getLong(ThinkerConstant.ID));
    }
